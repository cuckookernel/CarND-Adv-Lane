# -*- coding: utf-8 -*-
"""
Created on Thu Dec  6 15:53:12 2018
...
from common import DATA_DIR, rgb_read, rgb2gray
# Load our image - this should be a new frame since last time!
binary_warped = rgb2gray( rgb_read(DATA_DIR + 'warped-example.jpg') )
#%%
...
def fit_poly(img_shape, leftx, lefty, rightx, righty):
    ...
    right_fitx = np.polyval( right_fit, ploty ) #right_fit[0] + right_fit[1] * ploty + right_fit[2] * ploty**2
